...
import { Send, Bot, User, Loader2, BookOpen, Pencil, Trash2, Check, X } from 'lucide-react';
...
export default function ChatInterface({ chatTitle, welcomeMessage }: ChatInterfaceProps) {
    ...
    const userId = 'web-user-demo'; // Fixed ID for demo
                            ...
                            {isEditingTitle ? (
                                <div className="flex items-center gap-2 flex-1 max-w-md">
                                    <input
                                        ...
                                        autoFocus
                                    />
                                    <button onClick={handleTitleSave} className="p-1 hover:bg-green-100 rounded text-green-600">
                                        <Check className="w-4 h-4" />
                                    </button>
                                    <button onClick={() => { setIsEditingTitle(false); setTempTitle(currentTitle); }} className="p-1 hover:bg-red-100 rounded text-red-600">
                                        <X className="w-4 h-4" />
                                    </button>
                                </div>
                            ) : (
                                <div className="flex items-center gap-2 group">
                                    ...
                                    <button
                                        onClick={() => { setIsEditingTitle(true); setTempTitle(currentTitle); }}
